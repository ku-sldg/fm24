...
\begin{table}[h]
  ...
  \centering
  \footnotesize
  \begin{tabular}{|M{2.3cm}|M{9.5cm}|N}
      \hline
      Protocol Name & Actual protocol &\\
      %\hline
      % sys & *target: $\at{p4}{(vc\; p4\; sys)}$  &\\ 
      \hline   
      ker-vc-sys & *target:  $\at{p4}{(ker\; p4\; vc)}$ \texttt{+<+} $\at{p4}{(vc\; p4\; sys)}$ &\\ \hline 
      rtm-ker-vc-sys & *target: $\at{p1}{(rtm\; p4\; ker)}$ \texttt{+<+} $\at{p4}{(ker\; p4\; vc)}$ \texttt{+<+} $\at{p4}{(vc\; p4\; sys)}$ &\\
      \hline
      ker-hv-vc-sys & *target: $\at{p4}{(ker\; p4\; hv)}$ \texttt{+<+} $\at{p4}{(ker\; p4\; vc)}$ \texttt{+<+} $\at{p4}{(vc\; p4\; sys)}$ &\\ \hline 
  \end{tabular}
...
\begin{figure}[h]
    \begin{center}
        \begin{tabular}{ M{6cm} | M{6cm} }
            ...
            \end{tabular}
    \end{center}
    \caption{Normalized attack trees for ker-vc-sys and rtm-ker-vc-sys}
...
\begin{figure}[h]
  \begin{center}
      \begin{tabular}{ M{5.2cm} M{6.8cm} }
          ...
          \end{tabular}
  \end{center}
  \caption{Normalized attack trees for ker-hv-vc-sys}
