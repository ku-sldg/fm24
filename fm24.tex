...
requires at least as much adversary effort to generate evidence.
...
events that concern the adversary. It is possible for an attack tree
...
below, attack tree normalization reduces consecutive measurement
events to a single measurement event with a constant label, renaming
all remaining non-final measurement events. Normalization results in
attack trees containing only the events and information relevant to an
adversary.
